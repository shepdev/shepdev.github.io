...
export default class Sprite2 extends Sprite {
  constructor(...args) {
    ...
    this.costumes = [
      ...
      new Costume("costume3", "./Sprite2/costumes/costume3.svg", {
        x: 20.111209228021863,
        y: 29.207525227152814
      })
    ];
  ...
  *goTo(x6, y6, z6) {
    this.stage.vars.x =
      x6 * this.stage.vars.m1 +
      (y6 * this.stage.vars.m2 + z6 * this.stage.vars.m3);
    this.stage.vars.y =
      x6 * this.stage.vars.m4 +
      (y6 * this.stage.vars.m5 + z6 * this.stage.vars.m6);
    this.stage.vars.z =
      x6 * this.stage.vars.m7 +
      (y6 * this.stage.vars.m8 + z6 * this.stage.vars.m9);
    this.stage.vars.x =
      (this.stage.vars.x * this.stage.vars.viewFactor) /
      (this.stage.vars.z + 220);
    this.stage.vars.y =
  ...
  *whenKeyTPressed() {
    ...
    while (true) {
      ...
      yield* this.render();
      this.penColor = Color.rgb(232, 0, 0);
      yield;
    }
  }
